...
class Translate {
    constructor() {
        ...
        this.exchangeEl = document.getElementById('exchange');
        this.selectTag = document.querySelectorAll('select');
        this.btnicon = document.querySelectorAll('.ts-btn-icon');
        this.btn = document.getElementById('translatebtn');
        this.addoption();
        this.Translate();
        this.exchange();
        this.btnevent();
    ...
    btnevent() {
        this.btnicon.forEach(icon => {
            icon.addEventListener('click', ({ target }) => {
                var _a;
                if (((_a = icon.textContent) === null || _a === void 0 ? void 0 : _a.trim()) == "content_copy") {
